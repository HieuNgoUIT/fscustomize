...
class TransformerS2Model(FairseqEncoderDecoderModel):
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        ...
        return WrapperEncoderOfBERTTransformer(args.bert_model_name)
    ...
    def forward(
        ...
        bert_encoder_out = self.encoder.model(bert_input, attention_mask= ~bert_encoder_padding_mask)[0]
        if self.mask_cls_sep:
            bert_encoder_padding_mask += bert_input.eq(101)
            bert_encoder_padding_mask += bert_input.eq(102)
        ...
        #encoder_out = self.encoder.model(src_tokens)
...
class WrapperEncoderOfBERTTransformer():
